...
function toggleActivateRecordButton() {
  var b = $('#record-me');
  b.innerHTML = b.disabled ? '<span class="glyphicon glyphicon-play" aria-hidden="true"></span> Play' : '<span class="glyphicon glyphicon-play" aria-hidden="true"></span> Gravando...';
...
function embedVideoPreview(opt_url) {
  ...
  if (!video) {
    ...
    btnDownload.download = 'capture.webm';
